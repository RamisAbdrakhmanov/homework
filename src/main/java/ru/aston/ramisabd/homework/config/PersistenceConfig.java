package ru.aston.ramisabd.homework.config;
...
@EnableJpaRepositories(basePackages = "ru.aston")
...
public class PersistenceConfig {
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("javax.persistence.data-generation.create-script-source",
                environment.getProperty("javax.persistence.data-generation.create-script-source"));
        return properties;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        emf.setPackagesToScan("ru.aston.ramisabd");
